...
router.post("/apply", upload.single("file"), applyStudentController); // Public
router.get("/status/:email", checkStatusController); // Public Status Check
router.get("/applications", auth, getApplicationsController); // Admin
router.post("/approve/:id", auth, approveApplicationController); // Admin
router.post("/reject/:id", auth, rejectApplicationController); // Admin
