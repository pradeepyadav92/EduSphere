...
const AddMarks = () => {
  ...
  const handleSubmit = async () => {
    ...
    const hasInvalidMarks = Object.values(marksData).some((mark) => Number(mark) > maxMarks || Number(mark) < 0);
    if (hasInvalidMarks) {
      toast.error(`Marks cannot exceed ${maxMarks} or be negative`);
      return;
    }
            ...
            <div className="flex flex-col gap-4 w-[90%] mx-auto">
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="border p-3 rounded-md shadow">
                  ...
                  <p className="text-gray-800">
                    {selectedExam?.examType === "sessional1" ? "Sessional 1" : selectedExam?.examType === "sessional2" ? "Sessional 2" : selectedExam?.examType === "put" ? "PUT" : "Not Selected"}
                  </p>
                </div>
                <div className="border p-3 rounded-md shadow">
